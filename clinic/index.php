...
$majors = dataBaseConnection::getData("majors");
$doctors = dataBaseConnection::getData("doctors");
...
<body>
    <div class="page-wrapper">
        <?php
        if ((isset($_SESSION['auth']) && $_SESSION['auth']['role'] == 'user') || !isset($_SESSION['auth'])) {
                    ...
                    <div class="d-flex flex-wrap gap-4 justify-content-center">
                        ...
                        foreach ($majors as $major) {
                            ...
                            <div class="card p-2" style="width: 18rem;">
                                <img src="./majorImage/<?= $major['image'] ?>"
                                    ...
                                    <div class="card p-2" style="width: 18rem;">
                                        ...
                                        <div class="card-body d-flex flex-column gap-1 justify-content-center">
                                            ...
                                            <h6 class="card-title fw-bold text-center">
                                                <?= dataBaseConnection::getData("majors", "title", $doctor['major_id'])[0]["title"] ?>
                                            </h6>
